...
<body class="nav-md">
						...
						<div class="col-md-6 col-xs-12 container">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									action="../updateProject/${key}" onsubmit="return checkForm();">
										<!--  -->
										<div class="form-group">
											<label class="control-label col-md-2 col-sm-3 col-xs-12">프로젝트
												명</label>
											<div class="col-md-9 col-sm-9 col-xs-12">
												<input class="form-control" id="project_name" type="text" maxlength="50"
													name="project_name" placeholder="프로젝트 명" value = "${name}" required="required">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-2 col-sm-3 col-xs-12">발주
												기관</label>
											<div class="col-md-9 col-sm-9 col-xs-12">
												<input class="form-control" id="project_company" type="text" maxlength="30"
													name="project_company" placeholder="발주 기관" value = "${company}" required="required">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-2 col-sm-3 col-xs-12">사업
												금액(단위: 만 원)</label>
											<div class="col-md-9 col-sm-9 col-xs-12">
												<input class="form-control" id="project_money" type="number" min="0" max="2000000000"
													name="project_money" placeholder="사업 금액(단위: 만 원)" value = "${money}">
											</div>
										</div>
										<div class="form-group ">
											...
											<div class='col-md-9 col-sm-9 col-xs-12'>
												<div class='input-group date' id='myDatepicker2'>
													<input type='text' name="project_date_start" id="project_date_start" class="form-control" value = "${start}" required="required"/> <span
										...
										<div class="form-group ">
											...
											<div class='col-md-9 col-sm-9 col-xs-12'>
												<div class='input-group date' id='myDatepicker2_2'>
													<input type='text' name="project_date_end" id="project_date_end" class="form-control" value = "${end}" required="required"/> <span
														class="input-group-addon readonly"> <span
														class="glyphicon glyphicon-calendar"></span>
													</span>
												</div>
										...
										<div class="form-group">
											<label class="control-label col-md-2 col-sm-3 col-xs-12">진행상태</label>
											<div class="col-md-9 col-sm-9 col-xs-12">
												<select class="form-control" id="project_state"
													name="project_state" value="${state}">
										...
										<div class="form-group">
											<div class=" col-md-3 col-sm-3 col-xs-9 col-md-offset-10">
												...
												<button class="btn btn-danger" type="button" onclick = "location.href='../deleteProject/${key}'">삭제</button>
	...
	<script>
		...
		$("#project_state").val("${state}").attr("selected","selected");
	</script>
	...
	function checkForm() {
	    ...
	    if(project_date_start == '' || project_date_start == null){
	    	alert("시작일자를 확인해주세요.");
	    	return false;
	    }
	    if(project_date_end == '' || project_date_end == null){
	    	alert("종료일자를 확인해주세요.");
	    	return false;
	    }
	    
	    if(new Date(project_date_start) > new Date(project_date_end)){
			alert("종료일자가 시작일자보다 전입니다.");
			return false;
		}
