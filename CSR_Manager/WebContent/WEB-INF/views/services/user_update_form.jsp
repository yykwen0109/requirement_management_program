...
<body class="nav-md">
						...
						<div class="col-md-6 col-xs-12 container">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									action="../updateUser/${key}" method = "post" onsubmit="return checkForm();">
										<div class="form-group">
											...
											<div class="col-md-9 col-sm-9 col-xs-12">
												<input class="form-control" id="employee_name" type="text"  maxlength="50"
													name="employee_name" placeholder="직원 이름" value = "${name}" required="required">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-2 col-sm-3 col-xs-12">직원
										...
										<div class="form-group">
											<label class="control-label col-md-2 col-sm-3 col-xs-12">직원
												ID</label>
											<div class="col-md-9 col-sm-9 col-xs-12">
												<input class="form-control" id="employee_id" type="text"  maxlength="15"
													name="employee_id" placeholder="직원 ID" value = "${id}" required="required">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-2 col-sm-3 col-xs-12">직원
												PW</label>
											<div class="col-md-9 col-sm-9 col-xs-12">
												<input class="form-control" id="employee_pw" type="text"  maxlength="20"
													name="employee_pw" placeholder="직원 PW" value = "${password}" required="required">
											</div>
										</div>
										...
										<div class="form-group">
											<div class=" col-md-3 col-sm-3 col-xs-9 col-md-offset-10">
												...
												<button class="btn btn-danger" type="button" onclick = "location.href='../deleteUser/${key}'">삭제</button>
	...
	<script>
		...
		$("#employee_job").val("${job}").attr("selected", "selected");
	</script>
	<script>
