<%@page import="com.spring.ormVO.ProjectTable_Enum_State_VO"%>
							...
							<div class="col-lg-8  container">
								<div class="card">
									<div class="card-header">
										<strong>프로젝트 신청</strong>
									</div>
									<form class="form-horizontal"
										action="requirement_post_Add_Project" method="post">

										<div class="card-body">
											<div class="form-group row">
												<label class="col-md-4 col-form-label" for="select1">진행상태</label>
												<div class="col-md-7">
													<select class="form-control" id="select1"
														name="project_state">
														<option value="0">진행상태</option>
														<c:forEach items="${enum_state}" var="vo">
															<option value="${vo.state_key}">${vo.state_name}</option>
														</c:forEach>
													</select>
												</div>
											</div>
											...
											<div class="form-group row">
												<label class="col-md-4 col-form-label" for="text-input">고객회사</label>
												<div class="col-md-7">
													<input class="form-control" id="text-input" type="text"
														name="project_company" placeholder="고객 회사"> 
												</div>
											</div>

											<div class="form-group row">
												<label class="col-md-4 col-form-label" for="text-input">프로젝트
													이름</label>
												<div class="col-md-7">
													<input class="form-control" id="text-input" type="text"
														name="project_name" placeholder="프로젝트 이름"> 
												</div>
											</div>

											<div class="form-group row">
												<label class="col-md-4 col-form-label" for="select1">프로젝트
													유형</label>
												<div class="col-md-7">
													<select class="form-control" id="select1"
														name="project_type">
														<option value="0">프로젝트 유형</option>
														<c:forEach items="${enum_type}" var="vo">
															<option value="${vo.type_key}">${vo.type_name}</option>
														</c:forEach>
													</select>
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-7">
													<select class="form-control" id="select1"
														name="project_scope">
														<option value="0">프로젝트 계약구분</option>
														<c:forEach items="${enum_scope}" var="vo">
															<option value="${vo.scope_key}">${vo.scope_name}</option>
														</c:forEach>
													</select>
												</div>
											</div>
