...
<body
	...
	<header class="app-header navbar">
		...
		<ul class="nav navbar-nav d-md-down-none">
			<li class="nav-item px-3"><a class='' href='profile'><i
					class="fas fa-user"></i><span> ${userId} </span> </a>님 현재 진행중인 유지보수 사항이 <span>0</span>
				개 있습니다</li>
		</ul>
		<ul class="nav navbar-nav ml-auto">
			...
			<li class="nav-item px-3 d-md-down-none"><a class="nav-link"
				href="setting"><i class="fas fa-cog"></i> 검색</a></li>
	...
	<div class="app-body">
		...
		<ol class="breadcrumb">
			<li class="breadcrumb-item active">담당 유지보수 사항</li>
			<li class="breadcrumb-item"><a href="">담당 프로젝트</a></li>
			<!-- <li class="breadcrumb-item active">Dashboard</li> -->

			<li class="breadcrumb-menu d-md-down-none">
				<div class="btn-group" role="group" aria-label="Button group">
					<a class="btn" href=""> <i class="icon-graph"></i> <i
						class="far fa-envelope"></i>&nbsp;<a href='./downRequestExcel'> 전체 유지보수사항</a>
					</a> <a class="btn" href=""> <i class="icon-settings"></i> <i
						class="far fa-calendar-alt"></i>&nbsp;<a href='./downProjectExcel'> 전체 프로젝트</a>
					</a>
				</div>
			</li>
		</ol>
					...
					<div class="animated fadeIn">
							...
							<div class="col-lg-12">
								<div class="card">
									<div class="card-header">
										<i class="fa fa-align-justify"></i> 담당 요구사항
									</div>
									<div class="card-body">
									<table
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="card">
									<div class="card-header">
										<i class="fa fa-align-justify"></i> 담당 프로젝트
									</div>
									<div class="card-body">
										<table
											class="table table-responsive-sm table-bordered table-striped table-sm">
											...
											<tbody>
												<c:forEach items="${project_list}" var="vo">
													<tr bgcolor="white">
