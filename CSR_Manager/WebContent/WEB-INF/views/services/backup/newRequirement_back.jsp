		...
		<div class="sidebar">
			...
			<nav class="sidebar-nav">
				<ul class="nav">
					...
					<li class="nav-item"><a class="nav-link"
						href="myProceed"><i class="fab fa-buffer"></i> 진행중</a></li>
					<li class="nav-item"><a class="nav-link"
						href="myFinshed"><i class="fas fa-bug"></i> 완료</a></li>
					
					<li class="nav-title">전체 유지보수 사항</li>
					<li class="nav-item"><a class="nav-link"
						href="allProceed"><i class="fab fa-buffer"></i> 진행중</a></li>
					<li class="nav-item"><a class="nav-link"
						href="allFinshed"><i class="fas fa-bug"></i> 완료</a></li>
					...
					<li class="nav-item"><a class="nav-link" href="registerRequire"><i
							class="fas fa-meteor"></i> 유지보수 사항 등록 </a></li>
					<li class="nav-title"></li>
					<li class="nav-item nav-dropdown"><a class="nav-link" href="newProjects">
							<i class="fas fa-briefcase"></i> 프로젝트 신청현황
					</a></li>
					<li class="nav-title"></li>
										...
										<table
											...
											<thead>
												<tr>
													<th>Request_Key</th>
													<th>Project_Key</th>
													<th>Request_Requester_Name</th>
													<th>Request_Date_Upload</th>
													<th>Request_Emergency_Level</th>
													<th>Request_State</th>
													<th>Request_Classification</th>
													<th>Request_Work_Classification</th>
													<th>Request_Content</th>
													<th>Request_Content_Detail</th>
													<th>Request_Content_Detail_Review</th>
													<th>Request_Confirmation</th>
													<th>Request_Remarks</th>
												</tr>
											</thead>
											<tbody>
												<c:forEach items="${list}" var="vo">
													<tr bgcolor="white">
														...
														<td>${vo.request_Classification}</td>
